...
//     // Prevent updates if already approved or rejected
//     if (kaizenIdea.isApproved || kaizenIdea.status === "approved" || kaizenIdea.status === "rejected") {
//       return res.status(400).json({
//         success: false,
//         message: "This Kaizen has already been fully approved or rejected",
//       });
//     }
